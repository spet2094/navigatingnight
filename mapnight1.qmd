...
tm_shape(MENA_lights_mask) +
  tm_raster(breaks = c(0,20,30,40,50, Inf),
...
# Extract the values from MENA_lights_mask
lights_values <- values(MENA_lights_mask)

# Create the base map
tm_shape(MENA_lights_mask) +
  tm_raster(breaks = pretty_breaks(n = 5)(lights_values),  # Use pretty breaks
            palette = pal) +  
  tm_shape(MENA_adm1) +
